...
// Shimmer component
const ShimmerBox = ({ width = '100%', height = 20, borderRadius = 4 }: any) => (
  <Box
    sx={{
      width,
      height,
...
const MetricCardShimmer = () => (
  ...
  >
    <CardContent sx={{ p: 2.5, '&:last-child': { pb: 2.5 } }}>
      ...
      <ShimmerBox width="80px" height={32} />
    </CardContent>
  </Card>
);
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flex: 1 }}>
      ...
      <Box sx={{ flex: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
          <ShimmerBox width="200px" height={18} />
          <ShimmerBox width="60px" height={24} borderRadius={12} />
          <ShimmerBox width="70px" height={24} borderRadius={12} />
        </Box>
