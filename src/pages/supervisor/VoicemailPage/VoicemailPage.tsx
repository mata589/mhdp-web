// src/pages/supervisor/VoicemailPage/VoicemailPage.tsx
...
import type { Voicemail, VoicemailsResponse } from '../../../types/supervisor.types';
// Import supervisor API
import supervisorApi from '../../../services/api/supervisorApi';

// Type for risk level (from supervisor types)
type RiskLevel = "low" | "medium" | "high" | "critical";
type VoicemailStatus = "resolved" | "pending" | "escalated";
...
export const VoicemailPage: React.FC = () => {
  ...
  // States for play and view functionality
  ...
  // Fetch voicemails data using supervisor API
  useEffect(() => {
    const fetchVoicemails = async () => {
      try {
        ...
        const response = await supervisorApi.getVoicemails({
          limit: itemsPerPage,
          offset: offset,
  ...
  // If a voicemail is selected, show the call details page with supervisor context
  if (selectedCallId) {
    return (
      <CallDetailsPage
    ...
    <Box sx={{ bgcolor: '#f8fafc', minHeight: '100vh' }}>
      ...
      <Box sx={{ mb: { xs: 2, sm: 3 } }}>
        ...
        <Typography variant="body2" sx={{ color: '#6b7280', mt: 0.5 }}>
          Monitor and review all voicemails across agents
        </Typography>
      </Box>
                ...
                voicemails.map((voicemail) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell sx={{ py: 2, fontSize: { xs: '12px', sm: '14px' } }}>
                        <Typography variant="body2" sx={{ color: '#111827' }}>
                          Agent {voicemail.call_id.substring(0, 8)}
                        </Typography>
                      </TableCell>
                      <TableCell sx={{ py: 2 }}>
                        <Chip
