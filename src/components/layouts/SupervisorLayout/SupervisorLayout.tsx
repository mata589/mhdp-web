...
const supervisorNavItems = [
  ...
  { path: "/supervisor/voicemail", label: "Voicemail", icon: VoicemailIcon },
  { path: "/supervisor/missed-calls", label: "Missed calls", icon: MissedCallIcon },
...
export const SupervisorLayout: React.FC<SupervisorLayoutProps> = ({ children }) => {
  ...
  const currentPath = location.pathname === "/supervisor" ? "/supervisor/dashboard" : location.pathname
